...
/**
 * Fragment hiển thị lịch sử giao dịch (tab "Lịch sử" trong ViewPager2).
 *
 * <p>Chứa toàn bộ logic cũ của TransactionsFragment:
 * search, filter (Tất cả / Thu / Chi), danh sách giao dịch, empty state.
 *
 * <p>Được nhúng bên trong {@link TransactionsFragment} qua ViewPager2.
 */
